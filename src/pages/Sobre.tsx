      ...
      <section id="projetos" className="bg-[#232425] min-h-screen ">
        <div className="p-16 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
          ...
          <div className="max-w-sm bg-[#232425] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
              <a href="https://afschagas.github.io/nlwSports/">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-white dark:text-white">Projeto desenvolvido no evento Next Level Week (NLW) da Rocketseat</h5>
              </a>
              <p className="mb-3 font-normal text-white dark:text-gray-400">Nesse projeto utilizamos: HTML | CSS | GIT</p>
              <a href="https://afschagas.github.io/nlwSports/" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Consulte
          ...
          <div className="max-w-sm bg-[#232425] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
              <a href="https://afschagas.github.io/petshop/">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-white dark:text-white">Projeto desenvolvido em um treinamento on-line na Alura</h5>
              </a>
              <p className="mb-3 font-normal text-white dark:text-gray-400">Nesse projeto utilizamos: NodeJS | ReactJS | Json-Server | Axios | Eslint | Prettier | GIT</p>
              <a href="https://afschagas.github.io/petshop/" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Consulte
                <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </a>
            </div>
          ...
          <div className="max-w-sm bg-[#232425] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
              <a href="https://afschagas.github.io/boraCodar/02/index">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-white dark:text-white">Projeto desenvolvido no evento #boraCodar da Rocketseat</h5>
              </a>
